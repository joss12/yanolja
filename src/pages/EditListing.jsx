...
import { setDoc, serverTimestamp, addDoc, docRef, collection, doc, getDoc, updateDoc} from "firebase/firestore";
...
function CreateListing() {
    ...
    useEffect(()=>{
    /*this is going to check if the listing belongs 
    to the person who's editing it 
    */
