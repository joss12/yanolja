...
function Listing() {
  ...
  if (loading) {
    ...
    return (
      ...
      <FcShare className="text-lg text-slate-500" />
      </div>
      {shareLinkCopied && (
        <p className="
        fixed top-[23%]
      ...
      {/*This will take tow div's(1 for the map, 1 for information) */}
      <div className="m-4 flex flex-col md:flex-row max-w-6xl
      lg:mx-auto p-4 rounded-lg shadow
      ...
      <div className=" w-full ">
        ...
        space-x-2 ms:space-x-10 
        text-sm font-semibold mt-6">
        {/*Bedrooms */}
