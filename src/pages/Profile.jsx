        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form >
            ...
            whitespace-nowrap text-sm sm:text-lg mb-6">
              ...
              <p onClick={onLogout} className="text-green-600 hover:text-blue-800
              transition duration-200 ease-in-out cursor-pointer">Sign out
              </p>
            </div>
      ...
      <div className="max-w-6xl px-3 mt-6 mx-auto">
        {!loading && listings.length > 0 && (
          <>
            ...
            //this is a props for the delete passed in the ListingItem 
